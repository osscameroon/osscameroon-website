    ...
    <div className="text-center" id="developer-detail">
      ...
      <div className="item-center">
        <div className="w-75">
          ...
          <h4 className="mt-20">{data.title}</h4>

          <p className="mt-20">
            {data.location && (
              <span>
                {" "}
                <img alt="location icon" src={locationIcon} /> {data.location}{" "}
              </span>
            )}{" "}
            &emsp;
            {data.email && (
              <span>
                {" "}
                <img alt="email icon" src={emailIcon} /> {data.email}{" "}
              </span>
            )}{" "}
            &emsp;
            {data.url && (
              <a className="dark-color" href={data.url} rel="noreferrer" target="_blank">
                <img alt="url icon" src={urlIcon} /> {data.url}
              </a>
            )}
          </p>
          ...
          {data.summary && (
            <div className="mt-20">
              <h4>{t("developer:modal.summary")}</h4>
              <p>{data.summary}</p>
            </div>
          )}
          ...
          {data.yearsOfExperiences && (
            <h4>
              {t("developer:modal.yearOfExperience")} {data.yearsOfExperiences}
            </h4>
          )}
          ...
          {data.availabilities && (
            <p>
              <h4>
                {t("developer:modal.availability")} &nbsp;
